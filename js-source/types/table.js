...
(function ($) {
    "use strict";
       ...
       markup += '<ul class="option-table"><li data-preset="table-normal">Normal</li><li data-preset="table-simple">Einfach</li><li data-preset="table-advanced">Erweitert</li></ul>';
               ...
               if(target.length == 0){
                   ...
                   $(table).find('tr').last().children('td').first().children('.table-edit').trigger('click');
                    ...
                    setTimeout(function(){
                        ...
                        target = $(table).find('tr').last().children('td').first(); 
